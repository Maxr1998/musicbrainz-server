...
export default {
  ...
  'static/scripts/relationship-editor-v2/components/RelationshipEditorWrapper': (): Promise<mixed> => import('../static/scripts/relationship-editor-v2/components/RelationshipEditorWrapper.js'),
